...
function About() {
  return (
    <div class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p class="text-base text-gray-700 dark:text-gray-500 md:text-lg">
          WanderLust is a modern platform that connects travelers with hosts
      ...
      <div class="grid max-w-screen-lg gap-8 row-gap-10 mx-auto lg:grid-cols-2">
        <div class="flex flex-col max-w-md sm:mx-auto sm:flex-row">
          ...
          <div>
            <h6 class="mb-3 text-xl font-bold leading-5"> What is WanderLust?</h6>
            <p class="mb-3 text-sm text-gray-900 dark:text-gray-100">
              WanderLust is a platform that helps people find and book places to
        ...
        <div class="flex flex-col max-w-md sm:mx-auto sm:flex-row">
          ...
          <div>
            ...
            <p class="mb-3 text-sm text-gray-900 dark:text-gray-100">
              ...
              home — WanderLust makes it easy to list and earn.
            </p>
            <a
              href="/"
              aria-label=""
        ...
        <div class="flex flex-col max-w-md sm:mx-auto sm:flex-row">
          ...
          <div>
            ...
            <p class="mb-3 text-sm text-gray-900 dark:text-gray-100">
              Yes! WanderLust uses secure payment gateways and encrypted data
