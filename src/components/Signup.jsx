            ...
            >
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                ...
                authData.email ? (
                  ...
                  <button className="inline-block shrink-0 rounded-md border border-orange-600 bg-orange-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-orange-600 focus:outline-none focus:ring active:text-orange-500 disabled:bg-orange-200 disabled:hover:text-white">
                    Create an account
                  </button>
                )}
                ...
                <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                  ...
                  <Link
                    to="/login"
                    className=" dark:text-gray-100 underline font-semibold text-orange-500"
                  >
                    &nbsp;Log in
                  </Link>
                  .
